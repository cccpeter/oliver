 ...
 * @Desc: 重写客户端响应数据
 * @Remark: De
 * @Date: cretead in 2020/6/4 14:12
 * @Last Modified: by
 * @return value
 */
public class ClientResponeHandler  extends SimpleChannelInboundHandler<FullHttpRequest> {
    private Channel outChannel;
    /**
     * @Author: Oliver
     * @Desc: 加入客户端Channel
     * @Remark: Demand
     * @Date: cretead in 2020/6/4 14:14
     * @Last Modified: by
     * @return value
     */
    public ClientResponeHandler(Channel outChannel) {
